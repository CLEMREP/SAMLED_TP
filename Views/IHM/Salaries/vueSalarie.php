...
class vueSalarie {
    ...
    public function ajouterUnSalarie($dernierId, $listeDesPostes) {
        echo "<div class='relative z-10 pt-[120px] md:pt-[130px] lg:pt-[160px] pb-[100px] bg-black overflow-hidden'>
        <div class='container'>
          <div class='flex flex-wrap items-center -mx-4'>
            <div class='w-full px-4'>
              <div class='text-center'>
                <h1 class='font-semibold text-white text-4xl'>Gestion des salariés</h1>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class='max-w-[525px] mx-auto text-center bg-white rounded-lg relative overflow-hidden py-14 px-8 sm:px-12 md:px-[60px] wow fadeInUp' data-wow-delay='.15s'>
                <div class='mb-10 text-center'>
                  <a href='javascript:void(0)' class='inline-block'>
                    <h1 class='text-black text-2xl font-bold'><i class='bx bx-user mr-2'></i>Création du salarié</h1>
                  </a>
                </div>
                <form action='index.php?vue=Salarie&action=Creer' method='POST'>
                  <div class='mb-6'>
                    <input type='number' name='idSalarie' value='"; echo $dernierId; echo "'  placeholder='Numéro du salarié' class='w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary transition'  disabled required/>
                  </div>
                  <div class='mb-6'>
                    <input type='text' name='nomSalarie' placeholder='Nom du salarié' class='w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary transition' required/>
                  </div>
                  <div class='mb-6'>
                    <input type='text' name='commentaireSalarie' placeholder='Commentaire' class='w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary transition'  required/>
                  </div>
                  <div class='mb-6'>
                      <select name='idDuPoste' id='posteSelectionne' class='w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary transition'  required>";
                          echo $listeDesPostes;
                      echo "</select>
                  </div>
                  <div class='mb-10'>
                    <input type='submit' value='Création du salarié' class='w-full rounded-md border bordder-primary py-3 px-5 bg-black text-base text-white cursor-pointer hover:shadow-md transition duration-300 ease-in-out'/>
                  </div>
                </form>
    ...
    public function editerUnSalarie($id, $nomSalarie, $commentaire, $listeDesPostes) {
        echo "<div class='relative z-10 pt-[120px] md:pt-[130px] lg:pt-[160px] pb-[100px] bg-black overflow-hidden'>
        <div class='container'>
          <div class='flex flex-wrap items-center -mx-4'>
            <div class='w-full px-4'>
          ...
          <div class='flex flex-wrap -mx-4'>
            <div class='w-full px-4'>
              <div class='max-w-[525px] mx-auto text-center bg-white rounded-lg relative overflow-hidden py-14 px-8 sm:px-12 md:px-[60px] wow fadeInUp' data-wow-delay='.15s'>
                ...
                <form action='index.php?vue=Salarie&action=Modifier' method='POST'>
                  <div class='mb-6'>
                    <input type='number' value='"; echo $id; echo "'  placeholder='Numéro du salarié' class='w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary transition' disabled required/>
                    <input type='number' name='idSalarie' value='"; echo $id; echo "' class='hidden' />
                  </div>
                  <div class='mb-6'>
                    <input type='text' name='nomSalarie' value='"; echo $nomSalarie; echo "'  placeholder='Nom du salarié' class='w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary transition' required/>
                  </div>
                  <div class='mb-6'>
                    <input type='text' name='commentaire' value='"; echo $commentaire; echo "' placeholder='Commentaire' class='w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary transition' required/>
                  </div>
                  <div class='mb-6'>
                      <select name='idDuPoste' id='posteSelectionne' class='w-full rounded-md border bordder-[#E9EDF4] py-3 px-5 bg-[#FCFDFE] text-base text-body-color placeholder-[#ACB6BE] outline-none focus-visible:shadow-none focus:border-primary transition'  required>";
                          echo $listeDesPostes;
                  ...
                  <div class='w-full flex items-center space-x-4'>
                    <input type='submit' value='Modifier le salarié' class='w-full flex justify-center items-center rounded-md border bordder-primary py-3 px-5 bg-black text-base text-white cursor-pointer hover:shadow-md transition duration-300 ease-in-out'/>
                </form>
                  <form action='index.php?vue=Salarie&action=Supprimer' method='POST'>
                    <input type='number' name='idSalarie' value='"; echo $id; echo "' class='hidden'/>
                    <input type='submit' value='Supprimer le salarié' class='w-full flex justify-center items-center rounded-md border bordder-primary py-3 px-5 bg-red text-base text-white cursor-pointer hover:shadow-md transition duration-300 ease-in-out'/>
                  </form>
                </div>
    ...
    public function listeDesSalaries($lesSalaries) {
        echo "<div class='relative z-10 pt-[120px] md:pt-[130px] lg:pt-[160px] pb-[100px] bg-black overflow-hidden'>
        <div class='container'>
          <div class='flex flex-wrap items-center -mx-4'>
            <div class='w-full px-4'>
          ...
          <div class='flex flex-wrap -mx-4'>
            <div class='w-full px-4'>
              <div class='max-w-[1025px] mx-auto text-center bg-white rounded-lg relative overflow-hidden py-14 px-8 sm:px-12 md:px-[60px] wow fadeInUp' data-wow-delay='.15s'>
                <div class='mb-10 text-center'>
                  <a href='javascript:void(0)' class='inline-block'>
                    <h1 class='text-black text-2xl font-bold'><i class='bx bx-list-ul mr-2'></i>Listes des salariés</h1>
                  </a>
                </div>
