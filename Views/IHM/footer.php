...
<footer class="bg-black pt-20 lg:pt-[120px] relative z-10 wow fadeInUp" data-wow-delay=".15s">
      <div class="container">
        <div class="flex flex-wrap justify-between -mx-4">
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4 mr-2">
            <div class="w-full mb-10">
              <a href="index.php" class="inline-block max-w-[160px] mb-6">
                <h1 class="w-full header-logo text-white text-xl font-bold">SAMLED</h1>
              </a>
              <p class="text-base text-[#f3f4fe] mb-7">
                La société SAMLED est spécialisée en vente de véhicules de loisirs personnalisés.
              </p>
          ...
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12 px-4">
            <div class="w-full mb-10">
              <h4 class="text-white text-lg font-semibold mb-9">Pages</h4>
              <ul>
                <li>
                  <a href="index.php" class="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Accueil
                  </a>
                </li>
                <li>
          ...
          <div class="w-full sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12 px-4">
            <div class="w-full mb-10">
              <h4 class="text-white text-lg font-semibold mb-9">Gestion des postes</h4>
              <ul>
                <li>
                  <a href="index.php?vue=Poste&action=Ajouter" class="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Ajouter un poste
                  </a>
                </li>
                <li>
                  <a href="index.php?vue=Poste&action=Liste" class="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Liste des postes
                  </a>
                </li>
              </ul>
          ...
          <div class="w-full sm:w-1/2 md:w-2/3 lg:w-6/12 xl:w-3/12 px-4">
            <div class="w-full mb-10">
              <h4 class="text-white text-lg font-semibold mb-9">Gestion des salariés</h4>
              <ul>
                <li>
                  <a href="index.php?vue=Salarie&action=Ajouter" class="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Ajouter un salarié
                  </a>
                </li>
                <li>
                  <a href="index.php?vue=Salarie&action=Liste" class="inline-block text-base text-[#f3f4fe] hover:text-primary leading-loose mb-2">
                    Liste des salariés
                  </a>
                </li>
-              </ul>
    ...
    <!-- ====== Back To Top Start -->
    <a href="javascript:void(0)" class="hidden items-center justify-center bg-black text-white w-10 h-10 rounded-md fixed bottom-8 right-8 left-auto z-[999] hover:bg-dark back-to-top shadow-md transition duration-300 ease-in-out">
